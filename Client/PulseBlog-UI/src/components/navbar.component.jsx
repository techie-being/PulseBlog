    ...
    <>
      ...
      <nav className="navbar relative flex items-center justify-between p-4 bg-white">
        ...
        <div className="flex items-center gap-3 ml-auto">
          ...
          {!isLoggedIn ? (
            <>
              <Link className="btn-dark py-2 px-4 rounded-full" to="/signin">
                Sign In
              </Link>
              <Link
                className="btn-light py-2 px-4 rounded-full hidden md:block bg-grey"
                to="/signup"
              >
                Sign Up
              </Link>
                ...
                <div className="absolute right-0 top-14 w-60 bg-white border border-grey rounded-2xl shadow-2xl z-[150] overflow-hidden transform origin-top-right transition-all">
                  ...
                  <div className="py-2">
                    <Link
                      ...
                      className="flex items-center gap-3 px-6 py-3 hover:bg-grey text-sm transition-colors"
                  ...
                  <div className="border-t border-grey py-2">
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-6 py-3 hover:bg-red-50 text-sm text-red-500 transition-colors"
                    >
